...
CONTAINER="${CONTAINER:-homeassistant-build}"
...
docker cp "$CONTAINER":/home/mersdk/app/RPMS/harbour-homeassistant-${VERSION}-1.aarch64.rpm \
    "$ROOT/app/RPMS/"
echo "Built $ROOT/app/RPMS/harbour-homeassistant-${VERSION}-1.aarch64.rpm"
